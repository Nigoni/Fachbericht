...
\begin{itemize}
	...
	\item Ein weiterer Effekt ist das Erzeugen von akustischen Geräuschen. Dies tritt jedoch vor allem bei einem Frequenzbereich von \SI{1}{kHz} bis \SI{9}{kHz} auf, bei der die Amplitude 0.5\% vom Frequenzwert abweicht, sowie von der Art des beeinflussten Gerätes \cite{SpannungsNorm}.
\end{itemize}
