...
Die angewandten Normen sind in diesem Bericht nicht im Detail erläutert. Nur die für uns wichtigen Teile werden kurz beschrieben. Für weitere Segmente können die Normen nachgelesen werden. 
...
Bei dem Messverfahren muss die Prüfung mit den Allgemeinen Anforderungen durchgeführt werden. Diese beinhalten die Wiederholpräzision der Messung, der Anlauf und Stillsetzen eines Gerätes, die Anwendung der Grenzwerte für einzelne Oberschwingungsströme und den Prüfbericht der gesamten Informationen. Ausserdem ist die Festlegung der Dauer der Prüfung ein weiterer wichtiger Aspekt des Messverfahrens. In der Tabelle 4 sind die vier verschiedene Arten von Geräteverhalten dargestellt.

\subsubsection*{Grenzwerte für Oberschwingungsstrröme}
Um die Anwendbarkeit der Grenzwerte für Oberschwingungsströme eines Gerätes zu bestimmen, wurde ein Flussdiagramm erstellt. Die Prüfergebnisse des Instrumentes können mit dem Diagramm verglichen werden und so die Übereinstimmung mit der Norm gewährleisten.
Es gibt jedoch Arten von Geräten bei denen die Grenzwerte bei dieser Norm nicht festgelegt ist. Ein Beispiel wäre ein professionell genutztes Gerät mit einer Gesamt-Bemessungsleistung, die grösser als ein 1KW ist.

Bei den Geräten der Klasse A dürfen die Oberschwingungen des Eingangsstromes die Werte in der folgenden Tabelle nicht überschreiten.


\subsubsection{EN 61000-3-3}
Bei der folgenden Norm betrachtet man die Grenzwerte und die Begrenzung von Spannungsänderungen, Spannungsschwankungen und Flicker die in das öffentlichen Niederspannungs- Versorgungsnetzen eingeführt werden. Die Geräte und Einrichtungen werden unter festgelegten Bedingungen geprüft. Dieser Teil der Norm gilt für elektrische Geräte die mit einem Bemessungs- oder Eingansstrom bis zu 16 A pro Leiter haben und zum Anschluss an das öffentliche Niederspannungs- Verteilnetz mit einer Nennspannung von 220 V - 250 V mit einer Frequenz von 50 Hz vorgesehen sind. Sie unterliegen ausserdem keinen besonderen Anschlussbedingungen. Die Grenzwerte beziehen sich bei dieser Norm vor allem auf die Spannungsschwankungen, die von Verbrauchern wahrgenommen werden, die an der Schnittstelle zwischen Netzinhaber und Kundenanlage des Gerätenutzer angeschlossen werden. Daher können Störgrössen in der Stromversorgung entstehen, die die Grenzwerte überschreiten. Die kommt vor, wenn die tatsächliche impedanz am Anschlusspunkt des Gerätes innerhalb der Kundenanlage die Prüfimpedanz überschreiten. Die angegebenen Grenzwerte dieser Norm beinhalten vor allem auf dem abwechslungsreichen Empfinden von Flickern im Licht von 230V /60 W- Glühlampen, der durch Schwankungen des Netzes hervorgerufen wird.\\
Ein wichtiger Begriff für das Verständnis dieses Dokumentes ist der Flicker oder auch das Flimmern genannt. Es beschreibt den Eindruck von visueller Empfindlichkeit der Augen. Dies tritt meistens durch elektrische Spannungsschwankungen im Netz auf. Man nimmt dies Leuchtdichtschwankungen optisch bei Leuchtmitteln wie Leuchtstofflampen oder Glühbirnen wahr. Mit dem Flicker kann man ausserdem die Spannungsqualität des öffentlichen Netzes und die Netzrückwirkung des Verbrauches in ein solches Netz beurteilen.

\subsubsection*{Ermittlung von Spannungsänderung, Spannungsschwankung und Flicker}
In diesem Abschnitt geht es darum die relative Änderung der Spannung, die Kurzzeitflickerwerte und die Langzeitflickerwerte zu ermitteln. Für die relative Änderung der Spannung muss die Differenz von   
 

\subsubsection*{Grenzwerte}
Die folgenden Grenzwerte müssen für Spannungsschwankungen und Flicker an den Versorgungsklemmen des Prüflings angewendet werden. So fern die Prüfungen, welche durchgeführt wurden, die Grenzwerte dieser Norm einhalten, können als Typen geprüft angesehen werden. 
Die Prüfbedingung für die Grenzwerte beinhaltet folgende Bestimmungen:
\begin{itemize}
	\item Der Kurzzeitflickerwert Pst dar nicht grösser als 1.0 sein
	\item Der Langzeitflickerweg Pit darf nicht grösser als 0.65 sein
	\item Tmax, der  
	\item 
\end{itemize} 
